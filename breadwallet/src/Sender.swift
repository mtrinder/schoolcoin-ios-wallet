...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/schoolkoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/schoolkoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/schoolkoin-paymentack" && data.count <= 50000 {
