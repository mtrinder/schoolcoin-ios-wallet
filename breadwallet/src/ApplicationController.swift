...
class ApplicationController : Subscriber, Trackable {
    ...
    init() {
        // this assigns Swift functions to libBRCore function pointers
        // allowing calls into libSchnorr which has the secp256r1 curve and Schnorr signature routines
        setBRCoreCallbacks()
