...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/maxcoin-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/maxcoin-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/maxcoin-paymentack" && data.count <= 50000 {
